        ...
        >
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-2xl font-semibold mb-2 tracking-tight text-[#f5f5f4]">
                Contact Me
              </h3>

              <p className="text-[#cfc9be] text-sm mb-8">
              ...
              <button
                onClick={onClose}
                className="absolute top-3 right-4 text-[#cfc9be] hover:text-[#f5f5f4] transition text-lg"
              >
                ✕
              </button>
