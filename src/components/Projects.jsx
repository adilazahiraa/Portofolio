  ...
  const projects = [
    {
      ...
      links: [
        {
          label: "GitHub",
          url: "https://github.com/adilazahiraa/jobtracker-fullstack",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      links: [
        {
          label: "GitHub",
          url: "https://github.com/adilazahiraa/konserkita-ticketing-system",
        },
      ],
    },
    {
      ...
      links: [
        {
          label: "GitHub",
          url: "https://github.com/adilazahiraa/sosmedcare-expert-system",
        },
      ],
    },
    {
      ...
      <div className="relative z-10 mx-auto max-w-[1200px]">
        ...
        >
          ...
          <p className="mx-auto mt-6 max-w-[330px] font-manrope text-[13.5px] leading-7 text-[#FBF6EE]/70 sm:max-w-xl sm:text-[14px] md:mt-7 md:max-w-2xl md:text-[15px] md:leading-8">
            A curated collection of web, backend, UI/UX, and data projects.
          </p>
        </motion.div>
                  ...
                  <div className={`${isReverse ? "md:order-2" : ""}`}>
                    ...
                    <div className="mt-8 flex flex-wrap gap-3">
                      {project.links.map((link, index) => (
                        ...
                        >
                          {link.label}
                          <span className="ml-1 inline-block transition group-hover/link:translate-x-1">
                            →
                          </span>
                        </a>
                      ))}
